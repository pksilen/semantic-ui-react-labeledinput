...
describe('propTypes', () => {
  it('should validate prop types', () => {
    ...
    expect(propTypes.presentation).toBeTruthy();
...
describe('defaultProps', () => {
  it('should set default values for optional props', () => {
    const lineInputWrapper = mount(
      <LabeledInput inputId="input1" label="Value" onValueChange={onValueChangeMock} value="abc" />
    );
    ...
    expect(lineInputWrapper.props().presentation).toBe('box');
    expect(lineInputWrapper.props().size).toBe('huge');
...
describe('onInputBlur', () => {
  ...
  it('it should set hasValidValue to false and show error in "line" presentation input, if validation fails', () => {
    const lineInputWrapper = mount(
      <LabeledInput
        inputId="input1"
        label="Value"
  ...
  it('it should show error in "line" presentation input, if validation fails', () => {
    const lineInputWrapper = mount(
      <LabeledInput
        inputId="input1"
        label="Value"
    ...
    const inputDivWrapper = lineInputWrapper.find('div.ui.input');
    expect(inputDivWrapper.hasClass('error')).toBe(true);
  });
